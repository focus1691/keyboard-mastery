import { ROW_SCALE_FACTOR_X, ROW_SCALE_FACTOR_Y, NUM_SCALE_FACTOR_X, NUM_SCALE_FACTOR_Y, NUM_W } from '../utils/constants/letterboard';
...
class letterBoard extends Phaser.GameObjects.Container {
  constructor(scene, config) {
    ...
    // Phaser.Display.Align.In.TopCenter(this.middleRow, this.scene.add.zone(half(WIDTH), half(HEIGHT), WIDTH, HEIGHT), -half(NUM_W * NUM_SCALE_FACTOR_X), 0);
    Phaser.Display.Align.To.BottomCenter(this.middleRow, this.upperRow, 0, 0);
    ...
    // Phaser.Display.Align.In.TopCenter(this.bottomRow, this.scene.add.zone(half(WIDTH), half(HEIGHT), WIDTH, HEIGHT), -half(NUM_W * NUM_SCALE_FACTOR_X), 0);
    Phaser.Display.Align.To.BottomCenter(this.bottomRow, this.middleRow, 0, 0);
